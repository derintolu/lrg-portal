<?php
/**
 * Template for displaying single course in iframe (no header/footer)
 *
...
<head>
	...
	<style>
		...
		.tutor-page-wrap { padding: 24px; }
		.tutor-row { gap: 32px; }
		.tutor-col-xl-8 { flex: 0 0 calc(58% - 16px); max-width: calc(58% - 16px); }
		.tutor-col-xl-4 { flex: 0 0 calc(38% - 16px); max-width: calc(38% - 16px); }
	</style>
</head>
<body <?php body_class(); ?>>
